    ...
    public function run()
    {
        DB::table('subscription_plans')->insert([
            ...
            [
                ...
                'status'        => '1',
                'content'       => 'Our most popular package increases your earnings, listing limit, backgrounds removed per listing, and lowers your fees than the Seller package. More info about this package shows you how much you will earn on an item based on its profit. More info',
                'features' => '[{"name":"Your product will be posted under Consign It Away Account."},{"name":"You have 24\/7 support on all your products just call our toll free number or you can chat with us on the Chat Box!"},{"name":"All messages answered for you by one of our staff, if question is to complex about your product and you did not give us enough information about your item. You will be asked answer these question."},{"name":"Consign It Away keeps track of every dollar and you have access anytime to look at realtime transactions."},{"name":"We make sure all the governent tax has been paid."},{"name":"Once you take a photo the background of the product will disaper!"},{"name":"Once you enter your products deminstions the best shipping provider will caculate and you can pick the best shipping for the purchaser."},{"name":"We will have schedualed pick up and delivery from your house to the purchaser for you!"},{"name":"scan barcodes"},{"name":"A Storefront to showcase your products and seller profile"},{"name":"Add Multiple stores"},{"name":"Print labels and scedule picks for your orders all within your Consign It Away account!"},{"name":"Add upto 100 staff members in your team for full business managemnet"},{"name":"Your product will be posted under your own amazon Account."},{"name":"Your product will be posted under your own ebay Account."},{"name":"Your product will be posted under your own instagram Account."},{"name":"Your product will be posted under your own facebook Account."},{"name":"Your product will be posted under your own etsy Account."]},{"name":"Your product will be posted under your own google Account."},{"name":"Your product will be posted under your own walmart Account."},{"name":"Your product will be posted under your own consignt it away Account."}]',
                'created_at'  => Carbon::now(),
                'updated_at'  => Carbon::now()
            ],
