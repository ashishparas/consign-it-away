                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-2">
                                          ...
                                          <div class="input-group">
                                            <input type="text" class="@error('fname') is-invalid @enderror form-control" placeholder="Enter first name" name="fname">
                                          </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                          <label for="validationCustom02">Last Name</label>
                                          <div class="input-group">
                                            <input type="text" class="@error('lname') is-invalid @enderror form-control" placeholder="Enter last name" name="lname">
                                          </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                        ...
                                        <div class="col-md-4 mb-2">
                                          ...
                                          <div class="input-group">
                                            <input type="text" class="@error('mobile_no') is-invalid @enderror form-control" placeholder="Phone Number" name="mobile_no">
                                              </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                              <input type="text" class="@error('paypal_id') is-invalid @enderror form-control" placeholder="Enter payPal ID" name="paypal_id">
                                            </div>
                                          </div>
                                          <div class="col-md-4 mb-3">
                                            <label for="validationCustomUsername">Bank Account No.</label>
                                            <div class="input-group">
                                              <input type="text" class="@error('bank_ac_no') is-invalid @enderror form-control" placeholder="Enter account no." name="bank_ac_no">
                                                </div>
                                          </div>
                                          <div class="col-md-4 mb-3">
                                            <label for="validationCustom01">Routing Number</label>
                                            <div class="input-group">
                                              <input type="text" class="@error('routing_no') is-invalid @enderror form-control" placeholder="Enter routing no." name="routing_no">
                                            </div>
                                          </div>
                                          <div class="col-md-8 mb-3">
                                            <label for="validationCustom02">Street Address</label>
                                            <div class="input-group">
                                              <input type="text" class="@error('street_address') is-invalid @enderror form-control" placeholder="Enter Address" name="street_address">
                                            </div>
                                          </div>
                                          <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">City</label>
                                            <div class="input-group">
                                              <input type="text" class="@error('city') is-invalid @enderror form-control" placeholder="Enter city" name="city">
                                            </div>
                                          </div>
                                          <div class="col-md-4 mb-3">
                                            <label for="validationCustom01">State</label>
                                            <div class="input-group">
                                              <input type="text" class="@error('state') is-invalid @enderror form-control" placeholder="Enter State" name="state">
                                            </div>
                                          </div>
                                          <div class="col-md-4 mb-3">
                                            <label for="validationCustomUsername">Country</label>
                                            <div class="input-group">
                                              <input type="text" class="@error('country') is-invalid @enderror form-control" placeholder="Select Country" name="country">
                                                </div>
                                          </div>
                                          ...
                                          <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                              <input type="text" class="@error('zipcode') is-invalid @enderror form-control" placeholder="Enter zip-code" name="zipcode">
                                            </div>
                                          </div>
                                      </div>
