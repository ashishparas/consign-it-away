            ...
            <div class="col-xl-12 col-md-12">
                <div class="col-md-6 col-xl-6 mt-4">
                    <div class="ms-panel">
                      ...
                      <form action="{{url('/admin/create-subcategory')}}" method="post" enctype="multipart/form-data">
                        @csrf
                      <div class="ms-panel-body">
                              <div class="col-md-12 col-lg-12 mb-3">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="@error('title') is-invalid @enderror form-control" name="title" placeholder="Enter name">
                                </div>
                              </div>
