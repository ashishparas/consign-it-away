                      ...
                      <div class="ms-panel-body">
                              <div class="col-md-12 col-lg-12 mb-3">
                                ...
                                <div class="input-group">
                                  <input type="text" name="title" class="@error('title') is-invalid @enderror form-control" placeholder="" value="{{$category? $category->title:''}}">
                                </div>
                              </div>
                              <div class="pb-2 col-md-12 col-lg-12">
                               ...
                               <div class="pb-2 col-md-12 col-lg-12">
                                  <?php $photo = ($category->image)? $category->image:"No_image.png"; ?>
